...
class _SignInScreenState extends ConsumerState<SignInScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final isDark = a11y.themeMode == material.ThemeMode.dark ||
        (a11y.themeMode == material.ThemeMode.system &&
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color:
                                      AppTheme.queenPink.withValues(alpha: 0.6),
                                ),
                                boxShadow: [
                                  BoxShadow(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  sojornInput(
                                    ...
                                    onEditingComplete:
                                        _altchaToken != null ? _signIn : null,
                                    autofillHints: const [
                                  ...
                                  sojornButton(
                                    label: 'Sign In',
                                    onPressed:
                                        (isSubmitting || _altchaToken == null)
                                            ? null
                                            : _signIn,
              ...
              child: IconButton(
                ...
                onPressed: () {
                  ...
                  notifier.setThemeMode(
                    isDark ? material.ThemeMode.light : material.ThemeMode.dark,
                  );
                },
              ),
            ),
